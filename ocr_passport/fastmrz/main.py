...
fast_mrz = FastMRZ(tesseract_path=r"C:/Users/aishi/AppData/Local/Programs/Tesseract-OCR/tesseract.exe")
...
passport_mrz = fast_mrz.get_details("C:/Users/aishi/OneDrive/Desktop/Capstone/ocr_passport/data/passport_uk.jpg")
print("JSON:")
print(json.dumps(passport_mrz, indent=4))

print("\n")

passport_mrz = fast_mrz.get_details("C:/Users/aishi/OneDrive/Desktop/Capstone/ocr_passport/data/passport_uk.jpg", ignore_parse=True)
print("TEXT:")
print(passport_mrz)
...
print("\n")
image_file = open("C:/Users/aishi/OneDrive/Desktop/Capstone/ocr_passport/data/passport_uk.jpg", "rb")
